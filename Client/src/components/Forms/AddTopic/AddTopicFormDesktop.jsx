...
const AddTopicFormDesktop = (props) => {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className={styles.pc_title}>
                            Создание новой темы
                                ...
                                {({ input, meta }) => (
                                    <div className={styles.pc_select}>
                                        {meta.error && meta.touched && <div className={styles.error_message_select}>{meta.error}</div>}
                        ...
                        <Field name="title" validate={composeValidators(required, minValue(5), maxValue(100))}>
                            {({ input, meta }) => (
                                <div>
                                    <div className={styles.pc_label}>Название темы</div>
                        ...
                        <FieldArray name="attachments">
                            {({ fields, meta }) =>
                                fields.map((name, index) => (
                                    <div key={name}>
                                        <div className={styles.pc_attachment}>
                                        <Field
                                            name={`${name}.link`}
                                            component="input"
...
export default AddTopicFormDesktop